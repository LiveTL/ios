...
class IosFilterTests: XCTestCase {
    ...
    func testGeneralfilter() {
        ...
        let message = InjectedMessage(author: InjectedMessage.Author(id: "00", name: "Test", types: []), messages: [Message.text("(Aqua EN) Hello There")], showtime: 0.0, timestamp: Date.distantPast)
